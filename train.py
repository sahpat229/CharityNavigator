...
OUTPUT_MODEL_FILE = './models/svm/svm.pkl'
OUTPUT_CROSSVAL_FILE = './models/svm/svm_crossval.csv'
OUTPUT_TEST_FILE = './models/svm/svm_test.txt'
...
if _type == 'train':
    ...
    clf = GridSearchCV(estimator=svm.SVC(class_weight='balanced'),
...
if _type == 'test':
    ...
    print(np.sum(predict_labels != y_test))
